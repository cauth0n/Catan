...
public class CatanPanel extends JPanel {
	...
	public void buildClassicBoard(Graphics g) {
		int imageWidth = hillHex.getWidth(null);
		int imageHeight = hillHex.getHeight(null);
		...
		g.drawImage(getImageFromHexType(gameBoard.getHexboard().get(16).getHexType()), initialX, level5Y, null);
		g.drawImage(getImageFromHexType(gameBoard.getHexboard().get(17).getHexType()), initialX + imageWidth, level5Y, null);
		g.drawImage(getImageFromHexType(gameBoard.getHexboard().get(18).getHexType()), initialX + 2 * imageWidth, level5Y, null);
	}
